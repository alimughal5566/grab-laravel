...
class CartController extends Controller
{
    ...
    // if (Auth::guard('users')->check() && !empty(Auth::guard('users'))){
    ...
    { 
		...
		public function userDashboard()
		{
         ...
         // $account=DB::select("SELECT users.id,users.name,users.email,users.phone,customers.*,orders.id as oid,orders.c_quantity,orders.price,orders.users_id as uid,orders.created_at,orders.c_payment,orders.status FROM users JOIN customers ON customers.users_id=users.id JOIN orders ON orders.users_id=users.id WHERE users.id='$id'");

// $account=DB::select("SELECT users.id,users.name,users.email,users.phone,customers.*,orders.id as oid,orders.c_quantity,orders.price,orders.users_id as uid,orders.created_at,orders.c_payment,orders.status FROM users JOIN customers ON customers.users_id=users.id JOIN orders ON orders.users_id=users.id WHERE users.id='$id'");


  // echo "<pre>";var_dump($account);die;
