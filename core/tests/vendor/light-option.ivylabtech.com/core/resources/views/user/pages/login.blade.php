                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="page-title-content text-center">
                            <h2 class="text-upper">Account</h2>
                            <ol class="breadcrumb">
                                <li>
                        ...
                        <div class="login-register-wrapper">
                            <div class="login-register-tab-list nav">
                                <a class="active" data-toggle="tab" href="#lg1">
                                    <h4 style="color: #60ba62;"> login </h4>
                                </a>
                            ...
                            <div class="tab-content">
                                <div id="lg1" class="tab-pane active" style="border-top: 6px solid #60ba62;">
                                    <div class="login-form-container" style="padding: 40px 80px;">
                                        <div class="login-register-form">
                                           <!--  <form method="POST" action="{{ url('login-user') }}">
 -->
                                        <h3 style="text-align: center; margin-bottom: 35px; font-weight: 700; color: #60ba62;">Login to your account</h3>
