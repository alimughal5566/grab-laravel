                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="page-heading text-center">
                            <h3 class="font-2 color-main">{{ !empty($frontEndSetting->foodGalleryTitle1) ?  __($frontEndSetting->foodGalleryTitle1) : '' }}</h3>
                            <h2>{{ !empty($frontEndSetting->foodGalleryTitle2) ?  __($frontEndSetting->foodGalleryTitle2) : '' }}</h2>
                        </div>
                    </div>
                </div>
                <!--End Heading-->
