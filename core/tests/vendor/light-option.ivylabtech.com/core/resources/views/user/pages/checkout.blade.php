                    ...
                    <div class="col-lg-6 col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-6 mb-20">
                                    ...
                                    <input required placeholder="House number and street name" name="bstreet" type="text" id="bstreet">     
                                </div>
                                <div class="col-lg-12 col-md-6 mb-20">
                                ...
                                <div class="col-lg-12 col-md-6 mb-20">
                                 ...
                                 <div class="col-lg-12 col-md-6 mb-20">
                                    ...
                                    <input type="text" name="bzip" required id="bzip">    
                                </div> 
                                ...
                                <div class="col-lg-12 mb-20">
                                    <input id="address" name="bship" type="checkbox" data-target="createp_account"><strong><span>Ship to same Address</span></strong>
                                  <!--  <label class="righ_0" for="address" data-toggle="collapse" data-target="#collapseone" id="colapseone" aria-controls="collapseOne"></label> -->


                                  <!--   <label class="righ_0" for="address" data-toggle="collapse" data-target="#collapsetwo" aria-controls="collapseOne">Ship to different address</label> -->

                                   <!--   <div id="" class="collapse one" data-parent="#accordion"> -->
                                       ...
                                       <div class="row">
                                            ...
                                            <div class="col-lg-12 col-md-6 mb-20">
                                                <label>Street address  <span>*</span></label>
                                                <input name="sstreet" id="sstreet" placeholder="House number and street name" type="text">     
                                            </div>
                                            <div class="col-lg-12 col-md-6 mb-20">
                    ...
                    <div class="col-lg-6 col-md-6">
                            ...
                            <div class="payment_method">
                               <div class="panel-default">
                                    <input id="payment" checked name="cashondelivery[]" type="radio" data-target="createp_account">
