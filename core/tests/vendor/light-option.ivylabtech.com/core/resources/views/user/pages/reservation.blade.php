                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="page-title-content text-center">
                            <h2 class="text-upper">reservation</h2>
                            <ol class="breadcrumb">
                                <li>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="page-heading text-center">
                            <h3 class="font-2 color-main">{{!empty($frontEndSetting->reservation_title1) ? $frontEndSetting->reservation_title1 : ''}}</h3>
                            <h2 class="text-upper">{{!empty($frontEndSetting->reservation_title2) ? $frontEndSetting->reservation_title2 : ''}}</h2>
                        </div>
                    </div>
                </div>
                <!--End Heading-->
