            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-white font-weight-bold">
                        All Plans
                        <a href="{{route('admin.createplan')}}"><button type="button" class="btn btn-secondary float-right customs-btn-bd" style="margin-left: 10px;">
                            New Plan
                        </button></a>
                    </div>
                    <div class="card-body ">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <th scope="col"><img src="{{asset('assets/user/images/plans/'.$plan->plan_image)}}" class="img-thumbnail"
                                ...
                                <th scope="col"> 
                                    <a href="{{url('admin/addplandays',['id' => $plan->id])}}" class="btn btn-success btn-sm btn-square">View Days</a>

                                    <a href="{{url('admin/plan_edit',['id' => $plan->id])}}" class="btn btn-info btn-sm btn-square">Edit</a>
    ...
    <div class="modal modal-danger fade" id="foodDelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{url('admin/delete_plan')}}" method="post">
                    @csrf
