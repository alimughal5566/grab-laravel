...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Make Your Own Meal Status!</title>
                                        ...
                                        <table width="560" align="left" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner" style="border-bottom: 1px solid #eeeeee; text-align: left;">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <p style="font-size: 14px !important;line-height: 18px; color: #000;">Your order of <strong>{{$planname}}</strong> of food item <strong>{{$fooditem}}</strong> of <strong>{{$day}}</strong> for <strong>{{$foodtype}}</strong> status has been changed to <strong>{{$changed_up_status}}</strong>. Please review your profile.</p>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
