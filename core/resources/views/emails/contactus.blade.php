                                        ...
                                        <table width="560" align="left" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner" style="border-bottom: 1px solid #eeeeee; text-align: left;">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <p style="font-size: 14px !important;line-height: 18px; color: #000;">Here is following the contact us email</p>
                                                </tr>
                                                
                                                <tr>
                                                    <h3><strong>Name: </strong> <span style="font-weight: 400 !important;">{{$cus_name}}</span></h3>
                                                </tr>                                               
                                                <tr>
                                                    <h3><strong>Email: </strong> <span style="font-weight: 400 !important;">{{$cus_email}}</span></h3>
                                                </tr>                                               
                                                <tr>
                                                    <h3><strong>Sunject: </strong> <span style="font-weight: 400 !important;">{{$cus_subject}}</span></h3>
                                                </tr>                                               
                                                <tr>
                                                    <h3><strong>Message: </strong> <span style="font-weight: 400 !important;">{{$cus_message}}</span></h3>
                                                </tr>
