                                        ...
                                        <table width="560" align="left" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner" style="border-bottom: 1px solid #eeeeee; text-align: left;">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <p style="font-size: 14px !important;line-height: 18px; color: #000;">Thankyou for a being a part of Light Options Family. Following are your login credentials.</p>
                                                </tr>
                                                ...
                                                <tr>
                                                    <h3><strong>Password: </strong> <span style="font-weight: 400 !important;">{{$cus_password}}</span></h3>
                                                </tr>                                               
