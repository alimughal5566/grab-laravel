                                        ...
                                        <table width="560" align="left" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner" style="border-bottom: 1px solid #eeeeee; text-align: left;">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <p style="font-size: 14px !important;line-height: 18px; color: #000;">Your order of Plan Options <strong>{{$plan_name}}</strong> for <strong>{{$foodtype}}</strong> status has been changed to <strong>{{$changed_up_status}}</strong>. Please review your profile.</p>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
