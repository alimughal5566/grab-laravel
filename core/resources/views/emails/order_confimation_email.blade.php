                    ...
                    <td>
                        <table width="600" align="center" cellpadding="15" cellspacing="0" border="0" class="devicewidth" style="background-color: #ffffff;">
                            <tbody>
                                        ...
                                        <table width="560" align="left" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner" style="border-bottom: 1px solid #eeeeee; text-align: left;">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <p style="font-size: 14px !important;line-height: 18px; color: #000;">Thankyou for your order, we will get started on your order right away. Please review your profile.</p>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td style="padding-top: 0;">
                                        <table width="560" align="left" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner" style="border-bottom: 1px solid #eeeeee; text-align: left;">
                                            <tbody>
                                                <tr>
                                                    <td style="padding-bottom: 15px; text-align: left;color: #666666;">
                                                        <span style="font-size: 16px; font-weight: bold; color: #666666;">Shipping Adderss:</span> {{$light_opt_shipaddress}}
                                                    </td>
                                                ...
                                                <tr>
                                                    <td style="padding-bottom: 15px;text-align: left;color: #666666;">
                                                        <span style="font-size: 16px; font-weight: bold; color: #666666;">Billing Address:</span> {{$light_opt_billaddress}}
                                                    </td>
                                ...
                                @foreach($email_confiramtion_foods as $food)
                                <tr>
                                    <td style="padding-top: 0;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="font-size: 14px; line-height: 18px; color: #757575; padding-bottom: 10px;">
                                                        Type: @if($food->attributes->product_type=='product') Food Item @elseif($food->attributes->product_type=='plan') Plan @elseif($food->attributes->product_type=='plan_option') Plan Options @elseif($food->attributes->product_type=='meal') Make Your Own Meal @endif
                                                    </td>
                                                    <td style="font-size: 14px; line-height: 18px; color: #757575; text-align: right; padding-bottom: 10px;">
                                                        <b style="color: #666666;">KD {{$food->price}}</b>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
