                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3" style="text-align: center;">
                                        <button type="button" name="add" id="add" class="btn btn-cop"><i class="fas fa-plus"></i> Add Food</button>
                                    </div>
                                    <div class="col-md-4 mb-3"></div>
                                </div><br>
                                ...
                                <div class="col-md-4">
                                    <button type="submit" id="makeyourownmeal" class="btn btn-cop btn-block">Make Your Own Meal</button>
                                </div>
                                <div class="col-md-4"></div>
                                </div>
