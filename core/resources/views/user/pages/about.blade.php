                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="page-title-content text-center">
                            <h2 class="section-title-subtitler">@lang('About Us')</h2>
                            <ol class="breadcrumb">
                                <li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="about-content">
                                <h3 class="section-title-heading m-0">{{!empty($aboutSetting->about_title1) ? __($aboutSetting->about_title1) : ''}}</h3>
                                <h2 class="section-title-subtitle">{{!empty($aboutSetting->about_title2) ? __($aboutSetting->about_title2) : ''}}</h2>
                                <p>
