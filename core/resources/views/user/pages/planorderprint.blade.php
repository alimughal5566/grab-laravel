                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-9 col-lg-9">
                        <!-- Tab panes -->
                                 ...
                                 <div class="tab-pane">
                                <h3 class="ok"> Order Plan List Details
                                      <span style="margin-left: 55%"><input type="button" class="btn btn-primary" onclick="window.location='{{url('account')}}'" value="Back"></span>
<span style="margin-left: 1%"><input type="button" class="btn btn-success" onclick="doPrint()" value=" Print "></span>
              ...
              <!-- title row -->
                                            <div class="row">
                                                    ...
                                                    <h4>
                                                        <div class="cragus">
                                                    <i class="fas fa-globe"></i>Light Option</div>
