                            ...
                            <div class="col-lg-3">
                                <div class="shop-sidebar-wrapper gray-bg-7 shop-sidebar-mrg">
                                    <div class="shop-widget">
                                        ...
                                        {{--    for mobile --}}
                                        <span class="opens2" onclick="openNav()"><h4 class="shop-sidebar-title">Filter Your Meal<i
                                                    class="icofont icofont-navigation-menu"></i></h4></span>

                                        <div id="mySidenav" class="sidenav">

                                            <ul id="faq">
                                                <li class="nav-item"><a href="javascript:void(0)" class="closebtn"
                                                                        onclick="closeNav()">&times;</a></li>
                                                @foreach($result2 as $val)

                                                    <li class="nav-item"><a class="nav-link text-white"
                                                                            href="{{url('categoriespro',$val->id)}}">{{$val->food_category_name}}</a>
                                                    </li>
                                                @endforeach
                                            </ul>
                                                ...
                                                <div class="price_filter mt-25">
                                                    <form action="{{url('pricefilter')}}" method="get">
                                                        ...
                                                        <div class="slidecontainer">
                                                            ...
                                                            <input type="range" name="maxprice" min="0" max="2000" value="0"
                                            ...
                                            <div class="shop-price-filter mt-40 shop-sidebar-border pt-35">
                                                ...
                                                <div class="price_filter mt-25">
                                                    <form action="{{url('caloriefilter')}}" method="get">
                                                        ...
                                                        <div class="slidecontainer">
                                                            <input type="hidden" name="minprice" value="0">
                                                            <input type="range" name="maxprice" min="0" max="6000" value="0"
                                                                   class="slider1" id="myRangecal">
                                                        </div>
                                                    ...
                                                    <div class="product-wrapper">
                                                        <div class="product-img">
                                                            <a href="{{url('productdetail/'.$val->id)}}">
                                                                <img
                                                                    src="{{asset('assets/user/images/foods/'.$val->food_image)}}"
                                                                    alt="">
                                                        ...
                                                        <div class="product-content">
                                                            <h4>
                                                                ...
                                                                <center><a
                                                                        href="{{url('productdetail/'.$val->id)}}"><strong>{{$val->food_name}} </strong></a>
                                                                </center>

                                                            </h4>

                                                            <div class="product-price-wrapper" style="margin-bottom: 10px;">
                                                                <center><strong style="color:#a84d38;">{{$gs->currencySymbol}}
                                                                        <span>{{$val->food_price}}
                                                        </span></strong>
                                                                    </span>
                                                            ...
                                                            <div class="form-group row col-xs-12">
                                                                ...
                                                                <div class="col-md-2 col-xs-4">
                                                                    <label><?php echo $value->gramvalue?></label>
                                                                </div>
                                                                ...
                                                                <div class="col-md-2 col-xs-4">
                                                                    <label
                                                                        for="currentPassword"><?php echo $value->gramvalue?></label>
                                                                </div>
                                                            ...
                                                            <form action="{{url('/cart-add')}}" method="POST">
                                                                ...
                                                                <div class="cops">
                                                                    <button class="btn btn-cop col-md-offset-4">Add to cart
                                                                    </button>
                                                                </div>
