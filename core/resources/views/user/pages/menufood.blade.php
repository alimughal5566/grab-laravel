                            ...
                            <div class="header_right_info">
                                <div class="search_container">
                                       ...
                                       <form action="{{url('searchfood')}}" method="get">
                                        <div class="search_box" style="width: 540px">
...
<div class="shop-page-area pt-100 pb-100">
                   ...
                   <div class="col-lg-3">
                        <div class="shop-sidebar-wrapper gray-bg-7 shop-sidebar-mrg">
                            <div class="shop-widget">
                                    <div class="opens">
                                <a href="javascript:void(0)"><h4 class="shop-sidebar-title">Filter Your Meal<i class="icofont icofont-navigation-menu"></i></h4></a>
                            </div>
                    ...
                    <div class="col-lg-9">
                        <div class="banner-area pb-30">
                            <a href="javascript:void(0)">
                                <img  src="{{asset('assets/admin/img/banner/'.$baner[0]->image)}}" width="870px" height="200px" class="img"></a>
                        </div>
            ...
            <ul class="full_width sort_by_top_filters">
                    <li  class="sortby"><label>Sort By:</label></li>

                <li class="sortbyli"><a href="{{url('/price-asc')}}" class="btn btn-cop">Price Low to High</a></li>
                <li class="sortbyli"><a href="{{url('/price-desc')}}" class="btn btn-cop">Price High to Low</a></li>
              </ul>
