@extends('user.master')
@section('title',$gs->websiteTitle.' | Blog by category')
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="page-title-content text-center">
                            <h2 class="section-title-subtitle">@lang('Announcement by category')</h2>
                            <ol class="breadcrumb">
                                <li>
                                    <a href="{{route('user.home')}}">@lang('Home')</a>
                                </li>
                                <li class="active">@lang('Announcement')</li>
                            </ol>
                        </div>
                    </div>
                </div>
