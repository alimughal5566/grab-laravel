                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-9 col-lg-9">
                        <!-- Tab panes -->
                          ...
                          <div class="tab-pane">
                                <h3 class="ok">Order Plan Option List Details
                                      <span style="margin-left: 45%"><input type="button" class="btn btn-primary" onclick="window.location='{{url('account')}}'" value="Back"></span>
<span style="margin-left: 1%"><input type="button" class="btn btn-success" onclick="doPrint()" value=" Print "></span>
            ...
            <div class="row invoice-info">
                ...
                <!-- /.col -->
                    ...
                    <div class="row tbrows">
                        ...
                        <th rowspan="{{$count}}">Plan Option Name</th>
                        <th>Food Item</th>
                        <th>Food Type</th>
                        <th>Delivery Date</th>
                            </tr>
                    ...
                    @endif
                      ...
                      @foreach ($planopt_details1 as $key => $v)
                   ...
                   <td>
                     @if($v->food_type==1)
                    Breakfast
                    @elseif($v->food_type==2)
                    Lunch
                    @elseif($v->food_type==3)
                    Snacks
                    @elseif($v->food_type==4)
                    Dinner
                    @endif
                   </td>

                   <td class="rightdate">{{date('d-m-Y',strtotime($orders[0]->created_at))}}</td>
