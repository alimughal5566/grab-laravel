                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="page-title-content text-center">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Plan Options</li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="page-heading text-center">
                            <h3 class="section-title-heading color-main">Plan Options</h3>
                            <h2 class="section-title-subtitle">{{$planoptions->plan_name}}</h2>
                            ...
                            <div class="row" style="margin-top: 30px;">
                                <div class="col-md-6">
                                    <div class="facts-wrap">
                                        ...
                                        <div class="amount-per-serving">
                                            ...
                                            <div class=""><span
                                                    class="pull-left">Calories @if(isset($planoptions->plan_calories) && $planoptions->plan_calories!='') {{$planoptions->plan_calories}} @else
                                                        0 @endif</span>
                                                ...
                                                @if(sizeof($plancompostions) > 0)
                                                    @foreach($plancompostions as $plancompostion)
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="post-media lfood">
                                        ...
                                        @if(!empty($plan_image))
                                            <a href="#">
                                                <img src="{{asset('assets/user/images/planoptions/'.$plan_image)}}" class="img-responsive" alt="Image">
                                            </a>
                                        @else
                                            <a href="#">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="text-align: center;">
                            <p style="margin-top: 10px; font-size: 14px; text-align: center;">{{$planoptions->plan_description}}</p>
                        </div>
                        <div class="col-md-3"></div>
                    </div>
                </div>
                                                ...
                                                <div class="container">
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        ...
                                                        <li role="presentation" class="active"><a href="#breakfast"
                                                                                                  role="tab"
                                                                                                  data-toggle="tab"
                                                                                                  class="txhcolor brhcolor">BreakFast</a>
                                                        </li>
                                                        <li role="presentation"><a href="#lunch" role="tab"
                                                                                   data-toggle="tab"
                                                                                   class="txhcolor brhcolor">Lunch</a>
                                                        </li>
                                                        <li role="presentation"><a href="#snacks" role="tab"
                                                                                   data-toggle="tab"
                                                                                   class="txhcolor brhcolor">Snacks</a>
                                                        </li>
                                                        <li role="presentation"><a href="#dinner" role="tab"
                                                                                   data-toggle="tab"
                                                                                   class="txhcolor brhcolor">Dinner</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div role="tabpanel" class="tab-pane fade in active "
                                                            ...
                                                            <div class="food-listing-group">
                                                                ...
                                                                @foreach($planopt_details as $plandetail)
                                                                    @if($plandetail->food_type==1)
                                                                                   ...
                                                                                   class="lightbox" href="#">
                                                                                    <figure>
                                                                                        <img width="192" height="132"
                                                                                             src="@if($plandetail->food_image!='') {{asset('assets/user/images/planoptions/'.$plandetail->food_image)}} @else {{asset('assets/user/images/meal/noimage.png')}} @endif"
                                                                            ...
                                                                            <div class="food-type">
                                                                                <h5><a class="lightbox txcolor"
                                                                                       href="#">
                                                                                        @if($plandetail->food_type==1)
                                                                                            BreakFast
                                                                                        @elseif($plandetail->food_type==2)
                                                                                            Lunch
                                                                                        @elseif($plandetail->food_type==3)
                                                                                            Snacks
                                                                                        @elseif($plandetail->food_type==4)
                                                                                            Dinner
                                                                                        @endif
                                                                                    </a></h5>
                                                                            </div>
                                                        ...
                                                        <div role="tabpanel" class="tab-pane fade in " id="lunch">

                                                            <div class="food-listing-group">
                                                                @foreach($planopt_details as $plandetail)
                                                                    @if($plandetail->food_type==2)
                                                                        <div class="food-listing-row ">
                                                                            <div class="food-image">
                                                                                <a data-toggle="lightbox"
                                                                                   class="lightbox" href="#">
                                                        ...
                                                        <div role="tabpanel" class="tab-pane fade in " id="snacks">

                                                            <div class="food-listing-group">
                                                                @foreach($planopt_details as $plandetail)
                                                                    @if($plandetail->food_type==3)
                                                                        <div class="food-listing-row ">
                                                                            <div class="food-image">
                                                                                <a data-toggle="lightbox"
                                                                                   class="lightbox" href="#">
                                                        ...
                                                        <div role="tabpanel" class="tab-pane fade in " id="dinner">

                                                            <div class="food-listing-group">
                                                                @foreach($planopt_details as $plandetail)
                                                                    @if($plandetail->food_type==4)
                                                                        <div class="food-listing-row ">
                                                                            <div class="food-image">
                                                                                <a data-toggle="lightbox"
                                                                                   class="lightbox" href="#">
                                    ...
                                    <div class="panel-widget-style panel-widget-style-for-3573-0-0-4">
                                        <div class="so-widget-sow-button so-widget-sow-button-flat-888dd0636ead">
                                            ...
                                            <div class="ow-button-base ow-button-align-center">
                                                <form action="{{ route('user.orderplanoptions') }}" method="POST">
                                                    @csrf
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="gallery-button text-center">
                                                            <button type="submit"
                                                                    ...
                                                                    style="height: 60px;">Order This Plan Options Meal
                                                            </button>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4"></div>
