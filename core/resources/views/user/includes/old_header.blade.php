            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right" data-in="fadeIn" data-out="fadeOut">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"> <span class="nav-label">Plans Options</span></a>
                            <ul class="dropdown-menu animated fadeOut">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"> <span class="nav-label">Light Options</span></a>
                            <ul class="dropdown-menu animated fadeOut">
...
<li class="dropdown">
                                      ...
                                      <a href="{{url('cart')}}" class="btn btn-success" style="background-color: #fff; color: #60ba62; border-radius: 10px;">
                                      ...
                                      <ul class="dropdown-menu animated fadeOut" style="width: 450px; display: none; right: 0px; left: auto; padding: 10px">
                                          ...
                                          <?php
                                                ...
                                                <div class="cart_item">
                                                   <div class="cart_img">
                                                       @if($val->attributes->product_type=='product')
                                                       <a href="#"><img src="{{asset('assets/user/images/foods/'.$sql->food_image)}}" width="90px"></a>
                                                       @elseif($val->attributes->product_type=='meal')
                                                       <a href="#"><img src="{{asset('assets/user/images/foods/'.$sql->food_image)}}" width="90px"></a>
                                                       @elseif($val->attributes->product_type=='plan')
                                                       <a href="#"><img src="{{asset('assets/user/images/plans/'.$val->attributes->image)}}" width="90px"></a>
                                                       @elseif($val->attributes->product_type=='plan_option')
                                                       <a href="#"><img src="{{asset('assets/user/images/planoptions/'.$val->attributes->image)}}" width="90px"></a>
                                                       @endif
                                                   </div>
                                                    <div class="cart_info">
                                                        <a href="#">{{$val->name}}</a>
