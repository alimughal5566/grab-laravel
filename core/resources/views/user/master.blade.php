...
<?php
$footer=DB::table('front_end_settings')->select('phone','address')->get();
?>
    <div class="form-group row">
      <span class="fa fa-map-marker" style="color: #fff"></span>
      <label for="email" class="col-sm- col-form-label" style="color: #fff;font-size: 13px">Address :<span>{{$footer[0]->address}}</span></label>
      </div>

      <div class="form-group row" style="margin-top: -2%">
      <span class="fa fa-phone" style="color: #fff"></span>
      <label for="email" class="col-sm- col-form-label" style="color: #fff;font-size: 13px">Phone numbers :<span>{{$footer[0]->phone}}</span></label>
      </div>
          ...
          <div class="col-md-4" style="margin-top: -3%">
            <div class="footer-logo">
                <img src="{{asset('assets/user/images/frontEnd/food.png')}}" class="img-responsive footer-logo-main" alt="Image" width="20%">
            </div>
          </div>
            ...
            <div class="footer-social">
              <p style="color: #fff">Follow us on social media</p>
                <ul>
                    ...
                    <li><a href="{{$social->link}}" style="color: #fff !important;border:2px solid #fff !important;background-color: #fff !important"><i class="{{$social->icon}}" style="color:#a84d38 !important"></i></a></li>
                    @endforeach
                </ul>
            </div>
          </div>
        ...
        <div class="footer-bottom text-center">
            <p style="color: #fff">&copy; {{$frontEndSetting->footerText}}</p>
        </div>
