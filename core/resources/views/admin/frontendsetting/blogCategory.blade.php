...
@section('title', 'Promotion category')

@section('body')

    <div class="container-fluid">
        <h2 class="mb-4">Promotion Category</h2>
        <div class="row ">
            <div class="col-md-12">
                <div class="card">
            ...
            <div class="modal-content">
                ...
                <form action="{{!empty($blogCategory->id) ? route('admin.blogCategory.destroy','delete') : '#'}}"
                    ...
                    <div class="modal-body">
                        ...
                        <h4 class="text-center">Delete all Promotion, if you delete this ?</h4>
                    </div>
    ...
    <div class="modal modal-danger fade" id="create" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center" id="myModalLabel">Create Promotion</h4>
                </div>
                    ...
                    <div class="modal-body">
                        <div class="col-md-12 ">
                            <div class="form-group">
                                <label for="header_subtitle"><strong>Promotion Name</strong></label>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                <label for="header_subtitle"><strong>Promotion Status</strong></label>
