                            ...
                            <div class="shop-price-filter mt-40 shop-sidebar-border pt-35">
                                ...
                                <div class="price_filter mt-25">
                                   <form action="{{url('caloriefilter')}}" method="get">
                                    @csrf
                                <div class="slidecontainer">
                                    <input type="hidden" name="minprice" value="60">
                                  <input type="range" name="maxprice" min="1" max="6000" value="60" class="slider1" id="myRangecal">
                                </div>
                    ...
                    <div class="col-lg-9">
                        <div class="banner-area pb-30">
                            <a href="javascript:void(0)">
                                <img  src="{{asset('assets/admin/img/banner/'.$baner[0]->image)}}" width="870px" height="200px"></a>
                        </div>
                ...
                <li><a href="{{url('/price-desc')}}">Price, High to Low</a></li>
                        ...
                        <div class="grid-list-product-wrapper">
                            <div class="product-view pb-20 product-grid">
                                ...
                                <div class="row">
                                    @if(!empty($inventory) && $inventory->count())
                                        ...
                                        <div class="product-wrapper">
                                            ...
                                            <div class="product-content">
                                                ...
                                                <div class="product-price-wrapper">
                                                    <center><strong>KD.<span>{{$val->food_price}}
                                                        </span></strong>
                                                    </span>
