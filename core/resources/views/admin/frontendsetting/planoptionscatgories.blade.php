...
@section('body')
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($plancategory as $category)
                                <tr>
                                    ...
                                    <th scope="col"><img src="@if($category->category_image!=''){{asset('assets/user/images/planoptions/'.$category->category_image)}} @else {{asset('assets/user/images/meal/noimage.png')}} @endif" class="img-thumbnail" style="width:100px; height:100px;"></th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center" id="myModalLabel">Create Plans Options Category</h4>
                </div>
                <form action="{{route('admin.createplanoptioncategory')}}" method="post" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal modal-danger fade" id="CategoryEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center" id="myModalLabel">Update Plans Options Category</h4>
                </div>
                <form action="{{url('admin/updateplanoptioncat')}}" method="post" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal modal-danger fade" id="categoryDelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{url('admin/delete_planoptioncategory')}}" method="post">
                    @csrf
                    <div class="modal-body">
                        <input class="form-control form-control-lg mb-3" type="hidden" name="id" id="id">
...
<script>
    $('#plansoptions li:nth-child(1)').addClass('active');
