...
@section('body')
    <div class="container-fluid">
        <form action="{{url('admin/planoptions_update',['id' => $id])}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-lg mb-3" type="number" min="1" name="plan_calories" value="{{$fooditems->plan_calories}}" required>
                                    </div>
                                </div>
                                ...
                                <!--<div class="col-md-6 mb-3">-->
                                <!--    <div class="form-group">-->
                                <!--        <label for="header_subtitle"><strong>Plan Detail Image</strong></label>-->
                                <!--        <input class="form-control form-control-lg mb-3" type="file" name="plan_detail_image">-->
                                <!--    </div>-->
                                <!--</div>-->
...
<div id="addional_row_{{$key}}" class="row">
    ...
    <div class="col-md-2 mb-3">
        <div class="form-group">
            ...
            <input class="form-control mb-3" type="number" name="gmvalue[]" min="0" value="{{$compostions->gmvalue}}">
        </div>
    </div>
