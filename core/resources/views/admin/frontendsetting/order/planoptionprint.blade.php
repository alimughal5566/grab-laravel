...
@section('body')
    ...
    <div class="container-fluid">
       <h2 class="mb-4">
               Order Plan Option List Details
               <span style="margin-left: 50%"><input type="button" class="btn btn-primary" onclick="window.location='{{route('admin.planoptionlist')}}'" value="Back"></span>
              ...
              <div class="row">
                <div class="col-12 table-responsive">
                  <table class="table table-striped">
                   ...
                   <td>{{date('d-m-Y',strtotime($orders[0]->created_at))}}</td>
