                        ...
                        <table class="table table-hover mb-0">
                            ...
                            @foreach($orders as $key=>$order)
                                <tr>
                                    ...
                                    <td>{{$order->name}} {{$order->ul_name}} </td>
                                    <td>{{$order->phone}}</td>
                                    <td>{{$order->email}}</td>
                                    ...
                                    <td>
                                       <!--  <a href="{{route('admin.orderAccept',$order->id)}}"
                                        ...
                                        <!--<a href="{{route('admin.orderDetails',$order->id)}}" class="btn btn-info btn-sm btn-square">Detail</a>-->
                                         ...
                                         <a href="{{route('admin.momorderprintdays',['mid'=>$order->meal_id])}}"  class="btn btn-success btn-sm btn-square"><i class="fa fa-eye"></i></a>


                                        <a href="{{route('admin.momorderdays',['mid'=>$order->meal_id])}}" class="btn btn-success btn-sm btn-square">View Orders</a>
