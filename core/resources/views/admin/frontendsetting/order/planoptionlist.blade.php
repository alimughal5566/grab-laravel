                            ...
                            @foreach($orders as $key=>$order)
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       <a href="{{route('admin.planoptorder',['uid'=>$order->userid,'oid'=>$order->id,'pid'=>$order->planoption_id])}}" class="btn btn-success btn-sm btn-square"><i class="fa fa-eye"></i></a>

                                        <a href="{{route('admin.planooptionorder',['uid'=>$order->userid,'oid'=>$order->id,'pid'=>$order->planoption_id])}}" class="btn btn-success btn-sm btn-square">View Orders</a>
