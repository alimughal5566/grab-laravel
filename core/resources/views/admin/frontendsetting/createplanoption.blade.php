...
@section('title', 'Admin | Create - Plan Option')

@section('body')
    <div class="container-fluid">
        <form action="{{url('admin/storeplanoptions')}}" method="post" enctype="multipart/form-data">
            @csrf
            <h2 class="mb-4">
                PLans With Options
            </h2>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <div class="row">
                                ...
                                <!--        <input class="form-control form-control-lg mb-3" type="file" name="plan_detail_image" required>-->
                                <!--    </div>-->
                                <!--</div>-->
